    ...
    with tab3:
        ...
        with st.expander("더미데이터 생성 조건 (펼치기)"):
            st.markdown("""
                ...
                (4) 국적별 가입상품 / 손님의 상품 가입 확률 
                한국계 중국인 및 중국 : 원화 정기예금 40%, 외화예금 40%, 개인대출 10%, 해외펀드 5%, 국내펀드 5%, 퇴직연금 10%, 외국인 전용보험 50%, 외국인 전용카드 50%,당발송금은 F,E,H계열만 생성함, 타발송금은 비자종류 D계열만 생성함 
                
                미국 : 원화 정기예금 15% 외화예금 80%, 개인대출 5%, 해외펀드 20%, 국내펀드 10%, 퇴직연금 5%, 외국인 전용보험 30%, 외국인 전용카드 50%, 당발송금은 F,E,H계열만 생성함, 타발송금은 비자종류 D계열만 생성함 
                
                일본 : 원화 정기예금 15% 외화예금 80%, 개인대출 5%, 해외펀드 20%, 국내펀드 10%,퇴직연금 5%, 외국인 전용보험 30%, 외국인 전용카드 50%, 당발송금은 F,E,H계열만 생성함, 타발송금은 비자종류 D계열만 생성함 
                
                기타 국가 : 원화정기예금 5%, 외화예금 90%,, 개인대출 5%, 해외펀드 5%, 국내펀드 5%, 퇴직연금 5%, 외국인 전용보험 90%, 외국인 전용카드 50%, 당발송금은 F,E,H계열만 생성함, 타발송금은 비자종류 D계열만 생성함 
                ...
                월소득 100~300만원 : 가입금액 3만원
                월소득 300~400만원 : 가입금액 3만원
                월소득 400만원 초과 : 가입금액 3만원
